...
//EXPORT_SYMBOL(sys_cmask_insert_SPP_to_IAL);
//asmlinkage long (*sys_cmask_insert_SPP_to_IAL_real)(sector_t sector);
...
//	ret = syscall(333, sector);
	...
	//sys_cmask_insert_SPP_to_IAL_real = (long int *)*(sys_call_table + __NR_cmask_insert_SPP_to_IAL);
	//ret = sys_cmask_insert_SPP_to_IAL_real(sector);
